...
class iCaRL_DM(BaseLearner):
    ...
    def _construct_exemplar_synthetic(self, data_manager, m):
        ...
        data, targets, _ = data_manager.get_dataset(
            np.arange(self._total_classes - data_manager.get_task_size(
        ...
        syn_data, syn_lablel = self.dd.gen_synthetic_data(self._old_network,None,real_data,real_label,self._total_classes)
